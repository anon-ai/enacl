...
static
ERL_NIF_TERM enif_crypto_secretbox_MACBYTES(ErlNifEnv *env, int argc, ERL_NIF_TERM const argv[]) {
	return enif_make_int64(env, crypto_secretbox_MACBYTES);
}
...
static ErlNifFunc nif_funcs[] = {
	...
	{"crypto_secretbox_MACBYTES", 0, enif_crypto_secretbox_MACBYTES},
